    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_aboutus:
                ...
                Intent aboutus = new Intent(AboutProgramActivity.this, AboutActivity.class);
            ...
            case R.id.action_contacts:
                ...
                Intent contacts = new Intent(AboutProgramActivity.this, ContactusActivity.class);
            ...
            case R.id.action_about_program:
                ...
                Intent aboutprogram = new Intent(AboutProgramActivity.this, AboutProgramActivity.class);
